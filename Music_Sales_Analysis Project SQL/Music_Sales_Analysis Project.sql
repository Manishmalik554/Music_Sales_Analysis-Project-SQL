...
-- Q4 Which cty has the best customers? We would like to throw a
-- promotional music festival in he city we made the most money. Write
...
--  a query that return the Artist name and total track count of the top 10 rock bands.
...
-- length. Return the Name and Miliseconds for each track. Order by the song length with
...
-- country. Write a query that return the country along with the top customer and how much they
